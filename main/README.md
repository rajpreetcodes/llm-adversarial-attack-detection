...
# Offline end-to-end evaluation (deterministic, zero downloads)
...
# Run the API (/health, /v1/detect, /v1/chat/completions proxy, /admin/*)
...
- `results/`: generated evaluation tables and figures (synthetic mode).
