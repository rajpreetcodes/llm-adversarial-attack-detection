...
class Settings(BaseSettings):
    ...
    escalation_judge_weight: float = 0.7
    """Judge contribution when both escalation channels are healthy."""
    escalation_probe_weight: float = 0.3
    """Behavioural-probe contribution when both escalation channels are healthy."""
    escalation_block_threshold: float = 0.5
    """Threshold applied to the healthy escalation-tier fused score."""
